...
namespace MvcMusicStore.Models
{
    public class ShoppingCart
    {
        ...
        public static ShoppingCart GetCart(MusicStoreEntities storeContext, string username)
        {
            return new ShoppingCart(storeContext, username);
        }

        private static string GetCartId(HttpContextBase context, string username)
        {
