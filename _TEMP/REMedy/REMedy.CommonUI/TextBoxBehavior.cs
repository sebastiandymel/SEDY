...
namespace Remedy.CommonUI
{
    public class TextBoxBehavior : Behavior<TextBox>
    {
        ...
        public static readonly DependencyProperty CopyTextToClipboardProperty = DependencyProperty.Register("CopyTextToClipboard", typeof(bool), typeof(TextBoxBehavior), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectAllProperty = DependencyProperty.Register("SelectAll", typeof(bool), typeof(TextBoxBehavior), new PropertyMetadata(false));
        ...
        protected override void OnAttached()
        {
            ...
            AssociatedObject.MouseLeftButtonUp += async (s, e) => { await Task.Delay(500); Update();};
        }
